   ...
   Outputs:
    ...
    if propulsors.type != 'electric':
        if propulsors.type == 'hybrid':
            ...
            # Engine_oil
            eng_oil_wt = weight_engine_oil(eng_thrust/number_engines,number_engines)
    
            # Unusable_fuel
            unus_fuel_wt = weight_unusable_fuel(vehicle_type,number_engines,eng_thrust/number_engines,S_gross_w, \
                                                fuel_tanks,TOW-MZF)
        else:
            # Engine_oil
            eng_oil_wt = weight_engine_oil(eng_thrust/number_engines,number_engines)
