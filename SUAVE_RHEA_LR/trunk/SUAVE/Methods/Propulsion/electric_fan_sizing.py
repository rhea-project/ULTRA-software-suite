...
# electric_fan_sizing.py
# 
# Created:   July 2015, S. Karpuk
# Modified: 
#        
...
## @ingroup Methods-Propulsion
def electric_fan_sizing(electric_fan,mach_number = None, altitude = None, delta_isa = 0, conditions = None):  
    """
    creates and evaluates an electric_ducted_fan network based on an atmospheric sizing condition
    
    Inputs:
    electric_fan       electric fan network object (to be modified)
    mach_number
    altitude         [meters]
    ...
    # Setup Components   
    ram                       = electric_fan.ram
    inlet_nozzle              = electric_fan.electric_inlet_nozzle
    fan                       = electric_fan.electric_fan
    fan_nozzle                = electric_fan.electric_fan_nozzle
    thrust                    = electric_fan.thrust
    
    bypass_ratio              = electric_fan.bypass_ratio #0
    number_of_engines         = electric_fan.number_of_electric_engines
    ...
    ducted_fan.design_thrust = thrust.total_design * thrust.hybridization               # maximum design thrust based on the degree of hybridization
    ...
    ducted_fan.sealevel_static_thrust_electric = results_sls.thrust_force_vector[0,0] / number_of_engines 
