...
class Settings(Data):
        ...
        def __defaults__(self):
                ...
                self.filenames.avl_bin_name    = r'E:\avl3.36\avl.exe' # to call avl from command line. If avl is not on the system path, include absolute path to the avl binary
