...
def parasite_drag_pylon(state,settings,geometry):
    ...
    for propulsor in geometry.propulsors:
        ...
        pylon_parasite_drag += pylon_factor *  conditions.aerodynamics.drag_breakdown.parasite[propulsor.tag].parasite_drag_coefficient* (ref_area/geometry.reference_area * propulsor.number_of_engines) * ( 1 + CRUD )
