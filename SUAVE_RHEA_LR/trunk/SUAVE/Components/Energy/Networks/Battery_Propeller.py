...
class Battery_Propeller(Propulsor):
    ...
    def evaluate_thrust(self,state):
        ...
        # link with a gearbox
        gearbox.inputs.torque = motor.outputs.torque
        gearbox.inputs.speed  = motor.outputs.omega
        ...
        conditions.propulsion.motor_torque          = gearbox.outputs.torque
        conditions.propulsion.omega                 = outputs.omega*30/3.14
    ...
    def residuals(self,segment):
        ...
        #print(q_motor[:,0] - q_prop[:,0],segment.state.residuals.network[:,1])
        return    
