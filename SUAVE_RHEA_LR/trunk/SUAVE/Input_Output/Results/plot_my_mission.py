...
#            axes.grid(True)
            ...
            plt.savefig(case_name + "_engine_R.svg")
        else:
            axes = fig.add_subplot(2,1,1)
...
#        plt.savefig("LR_newDesign_engine.png")
    ...
    for segment in results.segments.values():
        ...
        if x_axes == 'range':
            ...
            plt.savefig(case_name + "_aero_R.svg")       
        else:
            axes = fig.add_subplot(3,1,1)
...
#        plt.savefig("LR_newDesign_aero.png")
    ...
    #   Aerodynamics 2
    # ------------------------------------------------------------------
    fig = plt.figure("Drag Components",figsize=(10,10))
    axes = plt.gca()
    for i, segment in enumerate(results.segments.values()):
        ...
        if x_axes == 'range':
            ...
            plt.savefig(case_name + "_drag_R.svg")      
        else:
            if line_style == 'bo-':
...
#            axes.grid(True)
            ...
            plt.savefig(case_name + "_mission_R.svg")   
        else:
            axes = fig.add_subplot(2,1,1)
...
#            axes.grid(True)
    ...
    for segment in results.segments.values():
        ...
        if x_axes == 'range':
            ...
            plt.savefig(case_name + "_velocity_R.svg")        
