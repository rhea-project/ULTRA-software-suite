...
from SUAVE.Analyses.Aerodynamics.SU2_wave_drag import SU2_wave_drag

# ----------------------------------------------------------------------
#  Analysis
# ----------------------------------------------------------------------
## @ingroup Analyses-Aerodynamics
class SU2_Euler_wavedrag(Markup):
    ...
    def __defaults__(self):
        ...
        compute.drag.compressibility.wings.wing    = SU2_wave_drag() 
    ...
    def initialize(self):
        ...
        self.process.compute.drag.compressibility.wings.wing.geometry = self.geometry
        ...
        self.process.compute.drag.compressibility.wings.wing.initialize()
