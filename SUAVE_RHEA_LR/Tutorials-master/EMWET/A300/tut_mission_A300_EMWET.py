...
def vehicle_setup():
    ...
    # mass properties
    vehicle.mass_properties.max_takeoff               = 170500 * Units.kilogram 
    vehicle.mass_properties.takeoff                   = 170500 * Units.kilogram   
    vehicle.mass_properties.operating_empty           = 10000 * Units.kilogram 
    vehicle.mass_properties.max_zero_fuel             = 130000 * Units.kilogram 
    ...
    # basic parameters
    vehicle.reference_area         = 260 * Units['meters**2']  
    ...
    segment.sweeps.quarter_chord  = 24 * Units.degrees
    ...
    section_1_airfoil.coordinate_file = 'n23105.dat'   
    ...
    segment.percent_span_location = 0.41
    segment.twist                 = 3 * Units.deg
    segment.root_chord_percent    = 0.5365
    ...
    segment.rear_spar             = 0.63

    section_2_airfoil = SUAVE.Components.Wings.Airfoils.Airfoil()
    section_2_airfoil.coordinate_file = 'n23105.dat'
    ...
    segment.twist                 = 3 * Units.deg
    segment.root_chord_percent    = 0.243
    ...
    section_4_airfoil.coordinate_file = 'n23105.dat'
    ...
    turbofan.origin            = [[13.72, 4,-1.9],[13.72, -4,-1.9]] # meters
