...
class Fuselage(Lofted_Body):
    ...
    def __defaults__(self):
        ...
        self.number_of_fuselages    = 1
        self.fuselage_number_factor = 1
        self.CARGF                  = 0.                       # Cargo aircraft floor factor (0.0 is for passengertransport
                                                            #                              1.0 is for military cargo transport
        ...
        self.areas.top_projected   = 0.0
        self.areas.wetted          = 0.0
        self.areas.cabin_floor     = 0.0                    # passenger cabin floor area
        ...
        self.air_conditioning = True                        # Indicator if AC is in the aicraft 
