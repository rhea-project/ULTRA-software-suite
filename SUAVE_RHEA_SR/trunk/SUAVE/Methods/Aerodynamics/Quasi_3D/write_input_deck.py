...
'''
    ...
    results_file1 = case.Trefftz_result_filename
    purge_files([results_file,str(results_file1)])
    case_command = base_case_command.format(index,res_type,results_file,res_type1,str(results_file1))
