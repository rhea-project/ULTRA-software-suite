...
def transform_section(geometry_file,wing):
    ...
    if len(wing.Segments.keys())>0:
        ...
        print(n_segments)
        for i_segs in range(1):
            points = wing.Segments[i_segs].Airfoil.airfoil.points
            ...
            wing.Segments[i_segs].Airfoil.airfoil.points = transformed_points
            wing.Segments[i_segs].origin                 = transformed_points[np.argmin(transformed_points[:,0]),:]
            #print('here')
            print(i_segs)
