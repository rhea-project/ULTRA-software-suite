...
class Settings(Data):
        ...
        def __defaults__(self):
                ...
                self.filenames.avl_bin_name    = r'C:\AE_Software\SUAVE_TUBS_se2a_V1\SUAVE_TUBS_se2a_V1\trunk\SUAVE\Methods\Aerodynamics\AVL_Loads\Data\avl.exe' # to call avl from command line. If avl is not on the system path, include absolute path to the avl binary
