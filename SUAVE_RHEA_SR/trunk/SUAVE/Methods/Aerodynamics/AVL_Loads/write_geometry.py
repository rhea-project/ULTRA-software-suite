...
'''   
    ...
    if avl_wing.vertical:
        ...
        for i in range(len(ordered_tags)):
            section_text    = make_wing_section_text(ordered_tags[i],spanwise_vortex_spacing)
    ...
    # Horizontal Wings        
        ...
        # Write text  
        for i in range(len(ordered_tags)):
            Nsect_tag = 'number_of_sections' in ordered_tags[i]
            if Nsect_tag is True:
                surface_text = surface_base_nosect.format(name,chordwise_vortices,chordwise_vortex_spacing,ydup)
                break
            else:
                surface_text = surface_base.format(name,chordwise_vortices,chordwise_vortex_spacing,spanwise_vortices,spanwise_vortex_spacing,ydup)
        for i in range(len(ordered_tags)):
...
def make_wing_section_text(avl_section,spanwise_vortex_spacing):
...
'''
    ...
    try:
        Nsect   = avl_section.number_of_sections
        wing_section_text = section_base_Nspan.format(x_le,y_le,z_le,chord,ainc,Nsect,spanwise_vortex_spacing)
    except:
