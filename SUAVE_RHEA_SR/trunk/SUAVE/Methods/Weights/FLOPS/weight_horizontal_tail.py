...
def weight_ht(NVT,SHT,DG,TRHT,ULF,VCMN,p_h,p_0,AC_type):
    ...
    if AC_type=='transport': 
      transport_ac_WHT = 0.53*SHT*DG**0.2*(TRHT+0.5)*NVT 
      WHT              = transport_ac_WHT
    #fighter/attack aircraft 
    elif AC_type=='fighter':
        fighter_ac_WHT = 0.002*SHT**0.87*(ULF*DG)**0.66*NVT
        WHT            = fighter_ac_WHT
