...
#    vehicle.landing_gear = landing_gear
    ...
    wing.sweeps.quarter_chord    = 27 * Units.deg
    #wing.thickness_to_chord      = 0.15
    wing.taper                   = 0.1
    wing.span_efficiency         = 0.9
    wing.spans.projected         = 34 * Units.meter
    wing.chords.root             = 6.011897704 * Units.meter
    wing.chords.tip              = 1.48828976 * Units.meter
    wing.chords.mean_aerodynamic = 4.235 * Units.meter
    wing.areas.reference         = 124.862 * Units['meters**2']  
    wing.twists.root             = 0.0 * Units.degrees
    wing.twists.tip              = 0.0 * Units.degrees
    wing.origin                  = [12.762,0,-1.09] # meters
    wing.vertical                = False
    wing.symmetric               = True
    wing.high_lift               = True
    ...
    segment.sweeps.quarter_chord  = 27.0 * Units.degrees
    segment.sections_outboard     = 2
	
    section_1_airfoil = SUAVE.Components.Wings.Airfoils.Airfoil()
    section_1_airfoil.coordinate_file = 'HL.txt'
    ...
    segment.percent_span_location = 0.117
    segment.twist                 = 0. * Units.deg
    segment.root_chord_percent    = 1
    ...
    section_2_airfoil.coordinate_file = 'HL.txt'
    ...
    segment.percent_span_location = 0.372
    segment.twist                 = 0. * Units.deg
    segment.root_chord_percent    = 0.623
    segment.dihedral_outboard     = 5 * Units.degrees
    ...
    section_3_airfoil.coordinate_file = 'HL.txt'
    ...
    segment.twist                 = 0. * Units.deg
    segment.root_chord_percent    = 0.247
    segment.dihedral_outboard     = 5 * Units.degrees
    segment.sweeps.quarter_chord  = 27 * Units.degrees
    segment.sections_outboard     = 3

    section_4_airfoil = SUAVE.Components.Wings.Airfoils.Airfoil()
    section_4_airfoil.coordinate_file = 'HL.txt'
    segment.append_airfoil(section_3_airfoil)
    #segment.thickness_to_chord    = 0.175
    wing.Segments.append(segment)
    ...
    wing.taper                   = 0.2
    wing.span_efficiency         = 0.9
    wing.spans.projected         = 14.92556 * Units.meter
    wing.chords.root             = 4.2  * Units.meter
    wing.chords.tip              = 1.25 * Units.meter
    ...
    wing.origin                  = [31.47,0,0.69] # meters
    wing.vertical                = False 
    wing.symmetric               = True
    ...
    segment = SUAVE.Components.Wings.Segment()
    segment.tag                   = 'section_2'
    segment.percent_span_location = 0.1646
    segment.twist                 = 0. * Units.deg
    segment.root_chord_percent    = 0.88549
    segment.dihedral_outboard     = 5 * Units.degrees
    segment.sweeps.quarter_chord  = 33 * Units.degrees
    segment.sections_outboard     = 7
    ...
    segment.percent_span_location = 1
    segment.twist                 = 0. * Units.deg
    segment.root_chord_percent    = 0.318
    segment.dihedral_outboard     = 5 * Units.degrees
    segment.sweeps.quarter_chord  = 33 * Units.degrees
    segment.sections_outboard     = 3
    ...
    wing.taper                   = 0.25
    wing.span_efficiency         = 0.9
    wing.spans.projected         = 9.64147*2 * Units.meter
    wing.chords.root             = 6.99018  * Units.meter
    wing.chords.tip              = 1.97005  * Units.meter
    wing.chords.mean_aerodynamic = 4.0   * Units.meter
    wing.areas.reference         = 27.316 * Units['meters**2']  
    wing.twists.root             = 0.0 * Units.degrees
    wing.twists.tip              = 0.0 * Units.degrees  
    wing.origin                  = [28.08,0,1.14] # meters
    wing.vertical                = True 
    ...
    segment = SUAVE.Components.Wings.Segment()
    segment.tag                   = 'section_2'
    segment.percent_span_location = 0.38165
    segment.twist                 = 0. * Units.deg
    segment.root_chord_percent    = 0.6595
    segment.dihedral_outboard     = 0 * Units.degrees
    ...
    segment.percent_span_location = 1
    segment.twist                 = 0. * Units.deg
    segment.root_chord_percent    = 0.2818
    segment.dihedral_outboard     = 0 * Units.degrees
    segment.sweeps.quarter_chord  = 39.2 * Units.degrees
    segment.sections_outboard     = 3
