...
def vehicle_setup():
    ...
    # mass properties
    vehicle.mass_properties.max_takeoff               = 95028 * Units.kilogram 
    vehicle.mass_properties.takeoff                   = 95028 * Units.kilogram   
    vehicle.mass_properties.operating_empty           = 10000 * Units.kilogram 
    vehicle.mass_properties.max_zero_fuel             = 63318 * Units.kilogram 
    vehicle.mass_properties.cargo                     = 10000.  * Units.kilogram   
    
    # envelope properties
    vehicle.envelope.ultimate_load = 3.75
    vehicle.envelope.limit_load    = 2.5
    vehicle.max_cruise_mach        = 0.83
    vehicle.max_altitude           = 10760 * Units.meters
    
    # basic parameters
    vehicle.reference_area         = 157.9 * Units['meters**2']  
    ...
    wing.spans.projected         = 32.92 * Units.meter
    wing.aspect_ratio            = wing.spans.projected**2 / vehicle.reference_area
    wing.sweeps.quarter_chord    = 30 * Units.deg
    wing.thickness_to_chord      = 0.11
    wing.taper                   = 0.35
    wing.span_efficiency         = 0.9
    wing.chords.root             = 8.78 * Units.meter
    wing.chords.tip              = 2.2 * Units.meter
    wing.chords.mean_aerodynamic = 5.86 * Units.meter
    wing.areas.reference         = vehicle.reference_area 
    wing.twists.root             = 3.0 * Units.degrees
    wing.twists.tip              = 0.0 * Units.degrees
    wing.origin                  = [19.82,0,5.02] # meters
    wing.vertical                = False
    wing.symmetric               = True
    wing.high_lift               = True
    ...
    segment.dihedral_outboard     = 4.1 * Units.degrees
    segment.sweeps.quarter_chord  = 32.3 * Units.degrees
    #segment.sections_outboard     = 2
    segment.front_spar            = 0.16
    segment.rear_spar             = 0.55
	
    section_1_airfoil = SUAVE.Components.Wings.Airfoils.Airfoil()
    section_1_airfoil.coordinate_file = 'b737a.dat'   
    ...
    segment.percent_span_location = 0.4149 
    segment.twist                 = 3.0 * Units.deg
    segment.root_chord_percent    = 0.5273
    segment.dihedral_outboard     = 3.0   * Units.degrees
    segment.sweeps.quarter_chord  = 29.69 * Units.degrees
    #segment.sections_outboard     = 7
    segment.front_spar            = 0.16
    segment.rear_spar             = 0.6

    section_2_airfoil = SUAVE.Components.Wings.Airfoils.Airfoil()
    section_2_airfoil.coordinate_file = 'b737d.dat'
    ...
    segment.twist                 = 3.00 * Units.deg
    segment.root_chord_percent    = 0.2506
    segment.dihedral_outboard     = 3.0 * Units.degrees
    segment.sweeps.quarter_chord  = 29.69 * Units.degrees
    #segment.sections_outboard     = 3
    #segment.thickness_to_chord    = 0.08
    segment.front_spar            = 0.25
    segment.rear_spar             = 0.66

    section_4_airfoil = SUAVE.Components.Wings.Airfoils.Airfoil()
    section_4_airfoil.coordinate_file = 'b737d.dat'
    ...
    wing.EMWET = True
    wing.materials = Data()
    wing.materials.type = 'metal'
    
    wing.materials.upper_panel = Data()
    wing.materials.upper_panel.E          = 7.10185e+010
    wing.materials.upper_panel.density    = 2795.68
    wing.materials.upper_panel.sigma_maxt = 4.8265e+008
    wing.materials.upper_panel.sigma_maxc = 4.6886e+008

    wing.materials.lower_panel = Data()
    wing.materials.lower_panel.E          = 7.37765e+010
    wing.materials.lower_panel.density    = 2795.68
    wing.materials.lower_panel.sigma_maxt = 3.24065e+008
    wing.materials.lower_panel.sigma_maxc = 2.68905e+008

    wing.materials.front_spar = Data()
    wing.materials.front_spar.E          = 7.10185e+010
    wing.materials.front_spar.density    = 2795.68
    wing.materials.front_spar.longitudinal = Data()
    wing.materials.front_spar.longitudinal.sigma_maxt = 4.8265e+008
    wing.materials.front_spar.longitudinal.sigma_maxc = 4.6886e+008
    ...
    wing.materials.front_spar.lateral.sigma_maxc = 496440000
    wing.materials.front_spar.lateral.sigma_ultt = 537810000
    wing.materials.front_spar.sigma_maxs = 269065000
    
    wing.materials.rear_spar = Data()
    wing.materials.rear_spar.E          = 7.10185e+010
    wing.materials.rear_spar.G          = 26.9e9
    wing.materials.rear_spar.density    = 2795.68
    wing.materials.rear_spar.longitudinal = Data()
    wing.materials.rear_spar.longitudinal.sigma_maxt = 4.8265e+008
    wing.materials.rear_spar.longitudinal.sigma_maxc = 4.6886e+008
    ...
    wing.materials.rear_spar.lateral.sigma_maxc = 496440000
    wing.materials.rear_spar.lateral.sigma_ultt = 537810000
    wing.materials.rear_spar.sigma_maxs = 269065000
    ...
    turbofan.origin            = [[13.72, 3.6,-1.9],[13.72, -3.6,-1.9]] # meters
