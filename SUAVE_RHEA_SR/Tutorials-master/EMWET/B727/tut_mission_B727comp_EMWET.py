...
def vehicle_setup():
    ...
    wing.EMWET = True
    wing.materials = Data()
    wing.materials.type = 'composite'
    
    wing.materials.upper_panel = Data()
    wing.materials.upper_panel.E          = 1.380e+11
    wing.materials.upper_panel.density    = 1600
    wing.materials.upper_panel.m          = 25
    wing.materials.upper_panel.n          = 50

    wing.materials.lower_panel = Data()
    wing.materials.lower_panel.E          = 1.380e+11
    wing.materials.lower_panel.density    = 1600
    wing.materials.lower_panel.m          = 25
    wing.materials.lower_panel.n          = 50

    wing.materials.front_spar = Data()
    wing.materials.front_spar.E          = 1.380e+11
    wing.materials.front_spar.density    = 1600
    wing.materials.front_spar.m          = 25
    wing.materials.front_spar.n          = 50
    
    wing.materials.rear_spar = Data()
    wing.materials.rear_spar.E          = 1.380e+11
    wing.materials.rear_spar.density    = 1600
    wing.materials.rear_spar.m          = 25
    wing.materials.rear_spar.n          = 50
