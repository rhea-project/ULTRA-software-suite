...
def vehicle_setup():
    ...
    #-------------------------------------------------------------------
    wing.fuel_tank = Data()
    wing.fuel_tank.start = 0.25
    wing.fuel_tank.end   = 0.6
    ...
    wing.materials.upper_panel.E          = 10.20185e+010
    wing.materials.upper_panel.G          = 7.10185e+010
    ...
    wing.materials.lower_panel.E          = 7.10185e+010
    wing.materials.lower_panel.G          = 7.10185e+010
    ...
    wing.materials.front_spar.G          = 7.10185e+010
    ...
    wing.materials.front_spar.longitudinal.sigma_ultt = 4.8265e+008   
    wing.materials.front_spar.lateral = Data()
    wing.materials.front_spar.lateral.sigma_maxt = 4.8265e+008
    wing.materials.front_spar.lateral.sigma_maxc = 4.6886e+008
    wing.materials.front_spar.lateral.sigma_ultt = 4.8265e+008
    wing.materials.front_spar.sigma_maxs = 4.6886e+008
    
    wing.materials.rear_spar = Data()
    wing.materials.rear_spar.E          = 7.10185e+010
    wing.materials.rear_spar.G          = 7.10185e+010
    ...
    wing.materials.rear_spar.longitudinal.sigma_ultt = 4.8265e+008   
    wing.materials.rear_spar.lateral = Data()
    wing.materials.rear_spar.lateral.sigma_maxt = 4.8265e+008
    wing.materials.rear_spar.lateral.sigma_maxc = 4.6886e+008
    wing.materials.rear_spar.lateral.sigma_ultt = 4.8265e+008
    wing.materials.rear_spar.sigma_maxs = 4.6886e+008
    ...
    turbofan.origin            = [[13.72, 4.86,-1.9],[13.72, 12,-1.9],[13.72, -4.86,-1.9],[13.72, -12,-1.9]] # meters
