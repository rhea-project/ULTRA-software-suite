...
def vehicle_setup():
    ...
    # mass properties
    vehicle.mass_properties.max_takeoff               = 20820 * Units.kilogram 
    vehicle.mass_properties.takeoff                   = 20820 * Units.kilogram   
    vehicle.mass_properties.operating_empty           = 10000 * Units.kilogram 
    vehicle.mass_properties.max_zero_fuel             = 18600 * Units.kilogram 
    vehicle.mass_properties.cargo                     = 10000.  * Units.kilogram   
    
    # envelope properties
    vehicle.envelope.ultimate_load = 3.75
    vehicle.envelope.limit_load    = 2.5
    vehicle.max_cruise_mach        = 0.55
    vehicle.max_altitude           = 10675 * Units.meters
    
    # basic parameters
    vehicle.reference_area         = 70 * Units['meters**2']  
    ...
    wing.spans.projected         = 29 * Units.meter
    wing.aspect_ratio            = wing.spans.projected**2 / vehicle.reference_area
    wing.sweeps.quarter_chord    = 0 * Units.deg
    wing.thickness_to_chord      = 0.18
    wing.taper                   = 0.4
    wing.span_efficiency         = 0.9
    wing.chords.root             = 3.464 * Units.meter
    wing.chords.tip              = 1.385 * Units.meter
    ...
    segment.twist                 = 3.27 * Units.deg
    segment.root_chord_percent    = 1
    segment.dihedral_outboard     = 2.48 * Units.degrees
    segment.sweeps.quarter_chord  = 1.462 * Units.degrees
    ...
    section_1_airfoil.coordinate_file = 'n64421.dat'   
    ...
    segment.percent_span_location = 0.7
    segment.twist                 = (3.27-1.4) * Units.deg
    segment.root_chord_percent    = 0.606
    segment.dihedral_outboard     = 2.5   * Units.degrees
    segment.sweeps.quarter_chord  = 1.646 * Units.degrees
    #segment.sections_outboard     = 7
    segment.front_spar            = 0.16
    segment.rear_spar             = 0.6

    section_2_airfoil = SUAVE.Components.Wings.Airfoils.Airfoil()
    section_2_airfoil.coordinate_file = 'n64415.dat'
    ...
    wing.materials.upper_panel.E          = 71018500000
    wing.materials.upper_panel.G          = 26.9e9
    wing.materials.upper_panel.density    = 2.79568e+03
    wing.materials.upper_panel.sigma_maxt = 489545000
    wing.materials.upper_panel.sigma_maxc = 482650000

    wing.materials.lower_panel = Data()
    wing.materials.lower_panel.E          = 71018500000
    ...
    wing.materials.front_spar.E          = 71018500000#7.10185e+10
    wing.materials.front_spar.G          = 26.9e9
    wing.materials.front_spar.density    = 2.79568e+03
    ...
    wing.materials.rear_spar.E          = 7.10185e+10
    wing.materials.rear_spar.G          = 26.9e9
    wing.materials.rear_spar.density    = 2.79568e+03
    ...
    wing.structures.rib_pitch        = 0.25
