...
def vehicle_setup():
    ...
    # basic parameters
    vehicle.reference_area         = 384 * Units['ft**2']  
    ...
    wing.chords.root             = 8  * Units.ft
    wing.chords.tip              = 8  * Units.ft
    wing.chords.mean_aerodynamic = 8 *  Units.ft
    wing.areas.reference         = 384 * Units['ft**2']   
    ...
    section_1_airfoil.coordinate_file = 'ClarkY.dat'
    ...
    section_2_airfoil.coordinate_file = 'ClarkY.dat'
