...
def vehicle_setup():
    ...
    # basic parameters
    vehicle.reference_area         = 25 * Units['ft**2']  
    ...
    wing.spans.projected         = 15 * Units.ft
    wing.chords.root             = 2.380  * Units.ft
    wing.chords.tip              = 0.953  * Units.ft
    wing.chords.mean_aerodynamic = 1.5 *  Units.ft
    wing.areas.reference         = 25 * Units['ft**2']   
    ...
    section_1_airfoil.coordinate_file = 'NACA65210.dat'
    ...
    segment.twist                 = 0. * Units.deg
    segment.root_chord_percent    = 0.383
    segment.dihedral_outboard     = 3.   * Units.degrees
    segment.sweeps.quarter_chord  = 0.0 * Units.degrees

    section_2_airfoil = SUAVE.Components.Wings.Airfoils.Airfoil()
    section_2_airfoil.coordinate_file = 'NACA65210.dat'
