...
class Aerodynamics(Analysis):
    ...
    def __defaults__(self):
        ...
        self.settings.fuselage_xt = 0.1                                 # Fuselage transition location
        self.settings.wing_xt     = 0.1                                 # Wing transition location    
        self.settings.prop_xt     = 0.1                                 # Propulstion system transition location
