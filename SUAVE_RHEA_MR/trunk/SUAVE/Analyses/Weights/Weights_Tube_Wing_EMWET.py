...
class Weights_Tube_Wing(Weights):
    ...
    def __defaults__(self):
       ...
       # Reduction factors are proportional (.1 is a 10% weight reduction)
        ...
        self.settings.load_factor = 2.5 # factor for GLA and MLA, 2.5 baseline and 1.0 1-g wing   
    ...
    def evaluate(self,conditions=None):
        ...
        empty    = SUAVE.Methods.Weights.Correlations.Tube_Wing_EMWET.empty
